...
- `dialog_completed` carries `agent_question_outstanding: true` when the dialog closed while the agent's last message still asked or announced a question; the terminal prints a line saying so
